        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="images/${productVO.productImage }.jpg" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="images/${productVO.productImage }.jpg" alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="images/${productVO.productImage }.jpg" alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src="images/${productVO.productImage }.jpg" alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">${productVO.productKind }</h1>
                            <p class="h3 py-2">${productVO.productPrice }원</p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>${productVO.productCategory }</strong></p>
                                </li>
                            </ul>

                            <h6>설명:</h6>
                            <p>${productVO.productContent }</p>
                          <!--   <ul class="list-inline">
                                <li class="list-inline-item">
                           ...
                           <!--  <h6>Specification:</h6>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    ...
                                    <div class="col d-grid">
                                    <a href="productCartAdd.go?id=${productVO.productId }" class="link_button2">장바구니 담기</a>
                                    </div>
                                </div>
                            </form>
