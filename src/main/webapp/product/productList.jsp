...
<body>
				...
				<ul class="list-unstyled templatemo-accordion">
					<li class="pb-3"><a
						...
						<ul class="collapse show list-unstyled pl-3">
							<li><a class="text-decoration-none" href="#">산모용품</a></li>
			...
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-md-6 pb-4">
						<div class="d-flex" id="shop__selector">
							<select class="form-control">
								<option id="basic">전체</option>
								<option id="sortAbc">가나다순</option>
								<option id="highPrice">높은가격순</option>
								<option id="rowPrice">낮은가격순</option>
									...
									<div class="card mb-4 product-wap rounded-0">
										<div class="card rounded-0">
											<img class="productListImage"
												src="images/${product.productImage }.jpg">
											<div
												...
												<ul class="list-unstyled">
													...
													<li><a 
														href="productView.go?id=${product.productId }">상세보기</a></li>
													<%-- <li><a class="btn btn-success text-white mt-2"
														href="productCartAdd.go?id=${productVO.productId }"><i class="fas fa-cart-plus"></i></a></li> --%>
												</ul>
											</div>
										</div>
										<div class="card-body">
											<a href="productView.go?id=${product.productId }"
												class="h3 text-decoration-none">${product.productKind }</a>
											<ul
											...
											<p class="text-center mb-0">${product.productPrice }원</p>
										</div>
									</div>
								</div>
							</c:forEach>
	...
	<!-- Footer -->
	<jsp:include page="/product/productBrands.jsp"></jsp:include>
