            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">임신질문</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">출산후기</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="http://localhost:8088/project/product/index.jsp">쇼핑몰로 가기</a>
                        </li>
                    </ul>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
               ...
               <br> &nbsp; &nbsp;
               <a class="nav-icon position-relative text-decoration-none" href="${pageContext.request.contextPath }/login/loginForm.jsp">
                     <img  src="${pageContext.request.contextPath }/product/assets/img/login-box-line.png" >로그인
                    </a>
                   <a class="nav-icon position-relative text-decoration-none"  href="${pageContext.request.contextPath }/login/registForm.jsp">
